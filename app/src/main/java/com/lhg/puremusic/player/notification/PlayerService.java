...
import com.lhg.architecture.data.usecase.UseCaseHandler;
import com.lhg.architecture.utils.ImageUtils;
import com.lhg.puremusic.MainActivity;
import com.lhg.puremusic.R;
import com.lhg.puremusic.data.bean.TestAlbum;
import com.lhg.puremusic.data.config.Configs;
import com.lhg.puremusic.data.usecase.DownloadUseCase;
import com.lhg.puremusic.player.PlayerManager;
import com.lhg.puremusic.player.helper.PlayerCallHelper;
import com.lhg.architecture.data.usecase.UseCase;
import com.lhg.architecture.data.usecase.UseCaseHandler;
import com.lhg.architecture.utils.ImageUtils;
import com.lhg.puremusic.MainActivity;
...
/**
 * Create by lhg at 19/7/17
 */
public class PlayerService extends Service {

    public static final String NOTIFY_PREVIOUS = "pure_music.lhg.previous";
    public static final String NOTIFY_CLOSE = "pure_music.lhg.close";
    public static final String NOTIFY_PAUSE = "pure_music.lhg.pause";
    public static final String NOTIFY_PLAY = "pure_music.lhg.play";
    public static final String NOTIFY_NEXT = "pure_music.lhg.next";
