...
import com.lhg.puremusic.player.helper.MediaPlayerHelper;
import com.lhg.puremusic.player.helper.PlayerFileNameGenerator;
import com.lhg.puremusic.player.utils.NetworkUtils;
        ...
        if (TextUtils.isEmpty(url)) {
            ...
            if ((url.contains("http:") || url.contains("ftp:") || url.contains("https:"))) {
                if (NetworkUtils.isConnected(context)) {
                    ...
                    Toast.makeText(context, "com.kunminx.player.R.string.unconnnect", Toast.LENGTH_SHORT).show();
                }
